...
if code_files:
    result = extract(code_files, cache_root=Path(r'D:\Vue\alajandria-book'))
    ...
    Path(r'D:\Vue\alajandria-book\graphify-out\.graphify_ast.json').write_text(json.dumps({'nodes':[],'edges':[],'input_tokens':0,'output_tokens':0}, ensure_ascii=False), encoding='utf-8')
    print('No code files')
